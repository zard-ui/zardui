...
import { Login02Component } from './login-02.component';

export const login02Block: Block = {
  id: 'login-02',
  ...
  category: 'Login',
  image: {
    light: '/blocks/login-02/light.png',
    dark: '/blocks/login-02/dark.png',
  },
  // Generated by `npm run sync:blocks` from the sibling component files — do not edit by hand.
  files: [
    {
      name: 'login-02.component.html',
      path: 'src/components/login-02/login-02.component.html',
...
`,
    ...
    {
      name: 'login-02.component.ts',
      path: 'src/components/login-02/login-02.component.ts',
