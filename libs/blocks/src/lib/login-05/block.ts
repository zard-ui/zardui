...
export const login05Block: Block = {
  id: 'login-05',
  title: 'Email-only login',
  description: 'A simple email-only login page.',
  component: Login05Component,
  category: 'Login',
  image: {
    light: '/blocks/login-05/light.png',
    dark: '/blocks/login-05/dark.png',
  },
  // Generated by `npm run sync:blocks` from the sibling component files — do not edit by hand.
  files: [
    {
      name: 'login-05.component.html',
      path: 'src/components/login-05/login-05.component.html',
...
`,
    ...
    {
      name: 'login-05.component.ts',
      path: 'src/components/login-05/login-05.component.ts',
