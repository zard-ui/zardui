...
export const login04Block: Block = {
  id: 'login-04',
  title: 'Login with form and image',
  description: 'A login page with form and image.',
  component: Login04Component,
  category: 'Login',
  image: {
    light: '/blocks/login-04/light.png',
    dark: '/blocks/login-04/dark.png',
  },
  // Generated by `npm run sync:blocks` from the sibling component files — do not edit by hand.
  files: [
    {
      name: 'login-04.component.html',
      path: 'src/components/login-04/login-04.component.html',
    ...
    <div class="flex flex-col gap-6">
      <z-card class="p-0">
        <div z-card-content class="grid p-0 md:grid-cols-2">
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="p-6 md:p-8">
            <div z-field-group>
...
`,
    ...
    {
      name: 'login-04.component.ts',
      path: 'src/components/login-04/login-04.component.ts',
