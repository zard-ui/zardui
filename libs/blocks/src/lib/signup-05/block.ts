...
import { Signup05Component } from './signup-05.component';

export const signup05Block: Block = {
  id: 'signup-05',
  title: 'Signup with social providers',
  description: 'A simple signup form with social providers.',
  component: Signup05Component,
  category: 'Signup',
  image: {
    light: '/blocks/signup-05/light.png',
    dark: '/blocks/signup-05/dark.png',
  },
  // Generated by `npm run sync:blocks` from the sibling component files — do not edit by hand.
  files: [
    {
      name: 'signup-05.component.html',
      path: 'src/components/signup-05/signup-05.component.html',
      content: `<div class="bg-background flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
    ...
    <div class="flex flex-col gap-6">
      <form [formGroup]="signupForm" (ngSubmit)="onSubmit()">
        <div z-field-group>
          ...
          <div z-field class="grid gap-4 sm:grid-cols-2">
...
`,
    ...
    {
      name: 'signup-05.component.ts',
      path: 'src/components/signup-05/signup-05.component.ts',
