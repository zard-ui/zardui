...
@Component({
  ...
  template: `
    <z-card class="w-full">
      <z-card-header>
        <z-card-title zTitle="Tooltip - Default" />
        <z-card-description zDescription="Default tooltip with z-chart-tooltip." />
      </z-card-header>
      <z-card-content>
        <z-chart
          zType="bar"
          ...
          class="w-full"
        >
          <z-chart-tooltip [zDefaultIndex]="1" />
        </z-chart>
      </z-card-content>
    </z-card>
  `,
...
export class ZardDemoChartTooltipDefaultComponent {
