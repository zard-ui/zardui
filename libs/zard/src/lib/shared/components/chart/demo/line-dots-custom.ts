...
export class ZardDemoChartLineDotsCustomComponent {
  ...
  protected readonly series: ZardChartSeries[] = [
    { dataKey: 'desktop', smooth: true, showSymbol: true, symbolSize: 12 },
  ];

  /** ECharts escape hatch: hollow diamonds instead of filled circles. */
  protected readonly customDots: ZardChartOptionOverride = {
    series: [{ symbol: 'diamond', itemStyle: { color: 'var(--background)', borderWidth: 2 } }],
  };
