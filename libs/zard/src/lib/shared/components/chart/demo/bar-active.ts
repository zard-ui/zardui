...
@Component({
  ...
  template: `
    <z-card class="w-full">
      <z-card-header>
        <z-card-title zTitle="Bar Chart - Active" />
...
export class ZardDemoChartBarActiveComponent {
  ...
  /** The highlighted bar: filled a little lighter and outlined with its own color, dashed. */
  private readonly active = {
    itemStyle: { opacity: 0.8, borderColor: 'var(--chart-3)', borderWidth: 2, borderType: 'dashed' },
  };

  protected readonly chartData = [
    { browser: 'chrome', visitors: 187, fill: 'var(--chart-1)' },
    { browser: 'safari', visitors: 200, fill: 'var(--chart-2)' },
    { browser: 'firefox', visitors: 275, fill: 'var(--chart-3)', ...this.active },
    { browser: 'edge', visitors: 173, fill: 'var(--chart-4)' },
    { browser: 'other', visitors: 90, fill: 'var(--chart-5)' },
  ];

  protected readonly series: ZardChartSeries[] = [{ dataKey: 'visitors', radius: 8 }];
