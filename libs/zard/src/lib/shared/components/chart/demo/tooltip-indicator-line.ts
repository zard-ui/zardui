...
@Component({
  ...
  template: `
    <z-card class="w-full">
      <z-card-header>
        <z-card-title zTitle="Tooltip - Line Indicator" />
        <z-card-description zDescription="Tooltip with line indicator." />
      </z-card-header>
      <z-card-content>
        <z-chart
          zType="bar"
          ...
          class="w-full"
        >
          <z-chart-tooltip zIndicator="line" [zDefaultIndex]="1" />
        </z-chart>
      </z-card-content>
    </z-card>
  `,
...
export class ZardDemoChartTooltipIndicatorLineComponent {
