...
export class ZardDemoChartRadarGridCircleFilledComponent {
  ...
  /** ECharts escape hatch: tint the polar grid, like shadcn's filled PolarGrid. */
  protected readonly filledGrid: ZardChartOptionOverride = {
    radar: { splitArea: { show: true, areaStyle: { color: ['transparent', 'var(--muted)'] } } },
  };
}
