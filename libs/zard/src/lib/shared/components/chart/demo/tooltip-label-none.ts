...
@Component({
  ...
  template: `
    <z-card class="w-full">
      <z-card-header>
        <z-card-title zTitle="Tooltip - No Label" />
        <z-card-description zDescription="Tooltip with no label." />
      </z-card-header>
      <z-card-content>
        <z-chart
          zType="bar"
          ...
          class="w-full"
        >
          <z-chart-tooltip zHideIndicator zHideLabel [zDefaultIndex]="1" />
        </z-chart>
      </z-card-content>
    </z-card>
  `,
...
export class ZardDemoChartTooltipLabelNoneComponent {
