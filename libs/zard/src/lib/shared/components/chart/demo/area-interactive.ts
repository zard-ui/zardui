  ...
  template: `
    <z-card class="w-full pt-0">
      <z-card-header class="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        ...
        <z-select class="hidden w-[160px] rounded-lg sm:ml-auto sm:flex" [(zValue)]="range">
          <z-select-item zValue="90d">Last 3 months</z-select-item>
          <z-select-item zValue="30d">Last 30 days</z-select-item>
          <z-select-item zValue="7d">Last 7 days</z-select-item>
        </z-select>
      </z-card-header>
