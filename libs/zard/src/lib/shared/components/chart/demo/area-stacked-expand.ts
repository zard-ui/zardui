...
@Component({
  ...
  template: `
    <z-card class="w-full">
      <z-card-header>
        <z-card-title zTitle="Area Chart - Stacked Expanded" />
        <z-card-description zDescription="Showing the share of each device over the last 6 months" />
      </z-card-header>
      <z-card-content>
        <z-chart
          zType="area"
...
export class ZardDemoChartAreaStackedExpandComponent {
