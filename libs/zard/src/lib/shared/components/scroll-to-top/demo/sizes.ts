    ...
    <div class="relative">
      <div class="bg-background h-150 overflow-y-auto rounded-lg border p-6">
        <div class="space-y-4">
          ...
          <p class="text-muted-foreground">Available sizes: small, medium, and large.</p>
        ...
        <z-scroll-to-top size="sm" target="parent" class="right-6 bottom-24" />
        <z-scroll-to-top size="md" target="parent" class="right-6 bottom-12" />
