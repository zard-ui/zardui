...
@Component({
  ...
  template: `
    ...
    <ng-template #contextMenu>
      <div z-navigation-menu-content class="w-48" data-testid="context-menu-content">
        <button type="button" z-navigation-menu-link (click)="log('Test')" data-testid="menu-item">Test Item</button>
      </div>
    </ng-template>
  `,
})
