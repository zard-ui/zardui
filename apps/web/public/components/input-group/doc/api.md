...
| `zAddOnBefore`          | `string \| TemplateRef`             | `undefined` | Content to display before the input            |
| `zAddOnAfter`           | `string \| TemplateRef`             | `undefined` | Content to display after the input             |
| `zPrefix`               | `string \| TemplateRef`             | `undefined` | Prefix content inside the input (left)         |
| `zSuffix`               | `string \| TemplateRef`             | `undefined` | Suffix content inside the input (right)        |
