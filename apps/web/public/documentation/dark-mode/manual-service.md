```typescript title="src/app/shared/services/dark-mode.ts" expandable="true" expandableTitle="Expand" showLineNumbers copyButton
...
```typescript title="src/app/shared/services/index.ts" showLineNumbers copyButton
