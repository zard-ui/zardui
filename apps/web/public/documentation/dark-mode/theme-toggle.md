...
@Component({
  ...
  template: `
    <button
      (click)="toggleTheme()"
      class="rounded-md p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800"
...
@Component({
  ...
  template: `
    <button
      (click)="toggleTheme()"
      class="relative rounded-full bg-gray-200 p-2 transition-all duration-300 hover:scale-105 dark:bg-gray-700"
    >
      <div class="relative h-6 w-6">
        <!-- Sun icon -->
        <svg
          class="absolute inset-0 h-6 w-6 text-yellow-500 transition-all duration-300"
        ...
        <!-- Moon icon -->
        <svg
          class="absolute inset-0 h-6 w-6 text-blue-400 transition-all duration-300"
