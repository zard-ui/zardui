...
import { SECTIONS, DOCS_PATH, CONTRIBUTE_PATH, COMPONENTS_PATH } from '@doc/shared/constants/routes.constant';
...
export class AiAssistComponent {
  ...
  private readonly appRoutes = [...SECTIONS.data, ...DOCS_PATH.data, ...CONTRIBUTE_PATH.data, ...COMPONENTS_PATH.data]
