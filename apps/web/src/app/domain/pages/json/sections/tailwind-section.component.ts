  ...
  template: `
    <section class="flex flex-col gap-8 sm:gap-10" scrollSpyItem="tailwind" id="tailwind">
      <div class="flex flex-col gap-4 sm:gap-6">
        <h2 class="font-heading mt-12 scroll-m-28 text-2xl font-semibold tracking-tight first:mt-0 sm:text-3xl lg:mt-20">Tailwind</h2>
        <div class="flex flex-col gap-3">
          <p class="text-muted-foreground text-base leading-relaxed sm:text-lg">Configuration to help the CLI understand how Tailwind CSS is set up in your project.</p>
      ...
      <div class="flex flex-col gap-8 sm:gap-10">
        <div id="tailwind-css" class="flex scroll-mt-20 flex-col gap-4">
          ...
          <p class="text-muted-foreground text-sm leading-relaxed sm:text-base">Path to the CSS file that imports Tailwind CSS into your project.</p>
        ...
        <div id="tailwind-cssvariables" class="flex scroll-mt-20 flex-col gap-4">
          ...
          <div class="flex flex-col gap-3">
            <p class="text-muted-foreground text-sm leading-relaxed sm:text-base">You can choose between using CSS variables or Tailwind CSS utility classes for theming.</p>
            <p class="text-muted-foreground text-sm leading-relaxed sm:text-base">
              To use utility classes for theming set <code class="bg-muted rounded px-1.5 py-0.5 text-xs sm:text-sm">tailwind.cssVariables</code> to
