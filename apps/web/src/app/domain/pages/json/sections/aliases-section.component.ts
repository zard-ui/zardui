  ...
  template: `
    <section class="flex flex-col gap-8 sm:gap-10" scrollSpyItem="aliases" id="aliases">
      <div class="flex flex-col gap-4 sm:gap-6">
        <h2 class="font-heading mt-12 scroll-m-28 text-2xl font-semibold tracking-tight first:mt-0 sm:text-3xl lg:mt-20">Aliases</h2>
        <div class="flex flex-col gap-3">
          <p class="text-muted-foreground text-base leading-relaxed sm:text-lg">
            The CLI uses these values and the <code class="bg-muted rounded px-1.5 py-0.5 text-xs sm:text-sm">paths</code> config from your
            <code class="bg-muted rounded px-1.5 py-0.5 text-xs sm:text-sm">tsconfig.json</code> file to place generated components in the correct location.
          </p>
          <p class="text-muted-foreground text-sm leading-relaxed sm:text-base">
            Path aliases have to be set up in your <code class="bg-muted rounded px-1.5 py-0.5 text-xs sm:text-sm">tsconfig.json</code> file.
          </p>
        </div>
      </div>
      ...
      <div class="flex flex-col gap-8 sm:gap-10">
        <div id="aliases-components" class="flex scroll-mt-20 flex-col gap-4">
          ...
          <p class="text-muted-foreground text-sm leading-relaxed sm:text-base">Import alias for your components.</p>
        ...
        <div id="aliases-utils" class="flex scroll-mt-20 flex-col gap-4">
          ...
          <p class="text-muted-foreground text-sm leading-relaxed sm:text-base">Import alias for your utility functions.</p>
