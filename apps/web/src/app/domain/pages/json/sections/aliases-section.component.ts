      ...
      <div class="flex flex-col gap-4 sm:gap-6">
        ...
        <div class="flex flex-col gap-3">
          <p class="text-muted-foreground text-base leading-relaxed sm:text-lg">
            ...
            <code class="bg-muted rounded px-1.5 py-0.5 text-xs sm:text-sm">paths</code> config from your
            <code class="bg-muted rounded px-1.5 py-0.5 text-xs sm:text-sm">tsconfig.json</code> file to place generated
            components in the correct location.
          </p>
          <p class="text-muted-foreground text-sm leading-relaxed sm:text-base">
            Path aliases have to be set up in your
            <code class="bg-muted rounded px-1.5 py-0.5 text-xs sm:text-sm">tsconfig.json</code> file.
          </p>
        </div>
      </div>
