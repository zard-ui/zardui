...
export const ANATOMY_PARTS: AnatomyPart[] = [
  ...
  },
  {
    ...
    breaksWhenMissing:
      'The 64 `data-*:` classes the library relies on silently compile to nothing — open/closed states, checked switches and selected menu items stop reacting. `animate-caret-blink` and every CSS utility also disappear.',
  },
  {
    id: 'plugin-animate',
